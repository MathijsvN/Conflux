...
def main():
    parser = argparse.ArgumentParser(
        description="Run the DatalogMTL → LARS translation for the vaccination example (data + program)."
    )
    ...
    parser.add_argument(
        "--program",
        dest="program_path",
        default="tests/programs/datalogmtl/vaccination_program.txt",
    ...
    program_out_path = output_dir / "vaccination_lars_program.txt"
